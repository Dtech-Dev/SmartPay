    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        result = new DrawerBuilder()
                ...
                .addDrawerItems(
                        ...
                        new PrimaryDrawerItem().withName(R.string.drawer_item_multi_drawer).withIcon(R.mipmap.ic_account_balance_wallet_white_24dp).withIdentifier(3).withBadge("beta"),
                        new PrimaryDrawerItem().withName(R.string.drawer_item_non_translucent_status_drawer).withIcon(R.mipmap.ic_lightbulb_outline_white_24dp).withIdentifier(4),
                        new PrimaryDrawerItem().withName(R.string.drawer_item_voucher).withIcon(FontAwesome.Icon.faw_gamepad).withIdentifier(5),
                        new PrimaryDrawerItem().withName(R.string.drawer_item_paket).withIcon(R.mipmap.ic_settings_ethernet_white_24dp).withIdentifier(6),
                        new PrimaryDrawerItem().withName(R.string.drawer_item_action_bar_drawer).withIcon(R.mipmap.ic_add_to_queue_white_24dp).withIdentifier(7),
